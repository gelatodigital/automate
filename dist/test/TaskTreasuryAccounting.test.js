...
describe("TaskTreasuryAccounting test", function () {
    ...
    before(function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pokeMeFactory = yield ethers.getContractFactory("PokeMe");
            const counterFactory = yield ethers.getContractFactory("Counter");
            const counterResolverFactory = yield ethers.getContractFactory("CounterResolver");
            treasury = (yield ethers.getContract("TaskTreasuryAccounting"));
            pokeMe = (yield pokeMeFactory.deploy(GELATO, treasury.address));
            ...
            yield treasury.addWhitelistedService(pokeMe.address);
        });
    });
