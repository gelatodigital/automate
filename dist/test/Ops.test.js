...
describe("Ops test", function () {
    ...
    beforeEach(function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            taskHash = yield ops.getTaskId(userAddress, counter.address, selector, true, ethers.constants.AddressZero, resolverHash);
    ...
    it("sender already started task", () => __awaiter(this, void 0, void 0, function* () {
        yield chai_1.expect(ops
            .connect(user)
            .createTask(counter.address, selector, counterResolver.address, resolverData)).to.be.revertedWith("Ops: createTask: Sender already started task");
    }));
    it("sender did not start task", () => __awaiter(this, void 0, void 0, function* () {
        yield ops.connect(user).cancelTask(taskHash);
        yield chai_1.expect(ops.connect(user).cancelTask(taskHash)).to.be.revertedWith("Ops: cancelTask: Sender did not start task yet");
    }));
    ...
    it("user withdraw more ETH than balance", () => __awaiter(this, void 0, void 0, function* () {
        ...
        const balanceBefore = yield ethers.provider.getBalance(ops.address);
        yield taskTreasury
            .connect(user)
            .withdrawFunds(userAddress, ETH, ethers.utils.parseEther("1"));
        const balanceAfter = yield ethers.provider.getBalance(ops.address);
    ...
    it("should exec and pay with ETH", () => __awaiter(this, void 0, void 0, function* () {
        ...
        // time not elapsed
        yield chai_1.expect(simulateExec(txFee, ETH, userAddress, true, resolverHash, counter.address, execData)).to.be.revertedWith("Ops.exec:Counter: increaseCount: Time not elapsed");
    }));
    ...
    it("getTaskIdsByUser test", () => __awaiter(this, void 0, void 0, function* () {
        ...
        const ids = yield ops.getTaskIdsByUser(userAddress);
