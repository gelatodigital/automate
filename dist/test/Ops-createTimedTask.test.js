...
describe("Ops createTimedTask test", function () {
    ...
    before(function () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            execSelector = yield ops.getSelector("increaseCount(uint256)");
            ...
            taskId = yield ops.getTaskId(userAddress, execAddress, execSelector, true, FEETOKEN, resolverHash);
    ...
    it("Exec should succeed when time elapse", () => __awaiter(this, void 0, void 0, function* () {
        ...
        const nextExecBefore = (yield ops.timedTask(taskId)).nextExec;
