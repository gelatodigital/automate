 ...
 * to create single execution resolver tasks.
 ...
 *
 * _createTask - Create a single execution resolver task.
...
abstract contract SingleResolverCreator is CreatorBase {
    ...
    function _createTask(
        ...
        ModuleData memory moduleData = _singleResolverModuleData(
            _resolverAddress,
            _resolverData
        );
    ...
    function _singleResolverModuleData(
        address _resolverAddress,
        bytes memory _resolverData
