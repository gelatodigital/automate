 ...
 * to create single execution time tasks.
 ...
 *
 * _createTask - Create a single execution time task.
...
abstract contract SingleTimeCreator is CreatorBase {
    ...
    function _createTask(
        ...
        ModuleData memory moduleData = _singleTimeModuleData(
            _startTime,
            _interval
        );
    ...
    function _singleTimeModuleData(uint256 _startTime, uint256 _interval)
        private
        pure
