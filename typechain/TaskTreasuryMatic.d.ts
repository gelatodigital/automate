...
interface TaskTreasuryMaticInterface extends ethers.utils.Interface {
  functions: {
...
export class TaskTreasuryMatic extends BaseContract {
  ...
  interface: TaskTreasuryMaticInterface;
