...
interface IResolverWithoutTreasuryInterface extends ethers.utils.Interface {
  functions: {
...
export class IResolverWithoutTreasury extends BaseContract {
  ...
  interface: IResolverWithoutTreasuryInterface;
